...
See [../PHASED_PLAN.md](../PHASED_PLAN.md) for delivery phases 0–18.
...
**Phase 7 (compliance + GRC — shipped):** `compliance` service (port **8086**), console **Compliance** (Overview, Explorer, Catalog, Checks, **GRC**), placement catalog + **qualitative characteristics** on provider/region, GRC standards/controls/evidence/cycles/packs/PDF export, object store for artifacts, project aggregate membership (blue), network and IP pool **delete guards** in `projects`. Diagrams: [03-tenancy](diagrams/03-tenancy.excalidraw), [06-phase-roadmap](diagrams/06-phase-roadmap.excalidraw). See [ADR 0010](adrs/0010-know-why-and-asset-criticality.md) and [operations/phase7-compliance-and-lifecycle-guards.md](../operations/phase7-compliance-and-lifecycle-guards.md).
